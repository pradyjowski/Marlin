...
#define STRING_CONFIG_H_AUTHOR "Patryk Nov20" // Who made the changes.
 ...
 *    99 : 100k MY CUSTOM THERMISTOR
 *old 99 : 100k thermistor with a 10K pull-up resistor (found on some Wanhao i3 machines)
 *
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    //#define DEFAULT_Kd 57.53
    // new 11/7/2020
    #define DEFAULT_Kp 52.55
    #define DEFAULT_Ki 10.22
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define DEFAULT_bedKp 157.19
  //#define DEFAULT_bedKi 30.67
  //#define DEFAULT_bedKd 537.14
  // new 11/7/2020
  #define DEFAULT_bedKp 78.59
  #define DEFAULT_bedKi 15.17
  #define DEFAULT_bedKd 271.41
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 800, 861.2 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 80, 80, 10, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 37, -1, -1.05 }
